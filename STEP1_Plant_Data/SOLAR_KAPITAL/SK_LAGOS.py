...
print("DATA for Lagos from Solar Kapital are beeing send here: ")
print(path_out)
...
driver.get('https://www.sunnyportal.com/RedirectToPlant/dc7be429-f476-4806-a4d7-7791baf06153')
# Accept Cookies
